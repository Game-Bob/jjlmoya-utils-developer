...
export const content: ToolLocaleContent<UrlEncoderDecoderUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: 'This tool performs clean, automatic calculations in your local browser. None of your URL strings need to be transmitted to third-party servers, which helps keep your tokens and analytics parameters private.',
    },
  ],
};
