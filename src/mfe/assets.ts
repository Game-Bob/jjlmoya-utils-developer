...
const UTILITY_ASSET_ROOT = "/_utilities/developer";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/developer/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/developer/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("developer");
